...
; 2. define apply underlying this evaluator
...
; 3. support primitive-procedures
...
; 4. define map on this evaluater, this reason has been explained exercize 4.14
(define evaluator
  '(begin
...
; Self-evaluating number and strings
...
(define (extend-environment vars vals base-env)
  (if (= (length vars) (length vals))
    ...
    (if (< (length vars) (length vals))
      (error 'TooManyArgumentSupplied vars vals)
      (error 'TooFewArgumentsSupplied vars vals))))
...
; Procedures for running the evalator as a program
...
(define (main args)
  ;(print-compiled-code (compile evaluator 'val 'next))
  (compile-and-go evaluator)
  ;=>
  ; (driver-loop)
  )
